        ...
        <Subscribe to={[UserContainer]}>
          {userInfo => (
            <div>
              ...
              { !userInfo.state.currentUser ? <div className="Main"><div class="lds-heart"><div></div></div><h2>Loading...</h2><div className="instagram"><span className="fa fa-instagram"></span> </div></div> : null }
